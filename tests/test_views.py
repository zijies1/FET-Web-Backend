...
def test_fet():
    ...
    with open(prefix + "subgroups.xml", "r") as fh:
        ...
        assert testResultStudent['name'] == "2019 Automatic Group Automatic Subgroup"
        assert testResultStudent['days'][0]['hours'][0]['name'] == 8
        assert testResultStudent['days'][0]['hours'][0]['subject'] == "physics"
